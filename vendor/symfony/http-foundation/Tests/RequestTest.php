...
class RequestTest extends TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $server['REQUEST_URI'] = '/IndexController.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/IndexController.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/IndexController.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/IndexController.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/IndexController.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/IndexController.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/IndexController.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide IndexController.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ IndexController.php [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/IndexController.php';
        $server['PHP_SELF'] = '/IndexController.php';
        $server['SCRIPT_FILENAME'] = '/some/where/IndexController.php';
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/IndexController.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/IndexController.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/IndexController.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/IndexController.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/IndexController.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/IndexController.php';
        $server['ORIG_SCRIPT_NAME'] = '/IndexController.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/IndexController.php',
                    'SCRIPT_NAME' => '/fruit/IndexController.php',
                    'PHP_SELF' => '/fruit/IndexController.php',
                ),
                '/fruit',
            ...
            array(
                '/fruit/strawberry/1234index.php/blah',
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/IndexController.php',
                    'SCRIPT_NAME' => '/IndexController.php',
                    'PHP_SELF' => '/IndexController.php',
                ),
                '',
                '/fruit/strawberry/1234index.php/blah',
            ),
